...
<div class="h-full px-3 py-4 overflow-y-auto bg-blue-700 dark:bg-gray-800">
   <a href="https://flowbite.com/" class="flex items-center ps-2.5 mb-5">
      ...
      <span class="self-center text-xl font-semibold whitespace-nowrap text-white">ProPlannd</span>
   </a>
   <ul class="space-y-2 font-medium">
      <li>
         <a href="/admin/dashboard" class="flex items-center p-2 text-white rounded-lg dark:text-white ">
            <svg class="w-5 h-5 text-white transition duration-75  group-hover:text-black" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
      ...
      <li>
         <a href="/admin/home" class="flex items-center p-2 text-white rounded-lg dark:text-white ">
      ...
      <li>
         <a href="/admin/about" class="flex items-center p-2 text-white rounded-lg dark:text-white ">
      ...
      <li>
         <a href="/admin/services" class="flex items-center p-2 text-white rounded-lg dark:text-white">
            ...
            <span class="flex-1 ms-3 whitespace-nowrap">All Services</span>
         </a>
      </li>
      <li>
         <a href="/admin/add" class="flex items-center p-2 text-white rounded-lg dark:text-white">
            ...
            <span class="flex-1 ms-3 whitespace-nowrap">Add Events</span>
         </a>
      </li>
      <li>
         <a href="/login/" class="flex items-center p-2 text-white rounded-lg dark:text-white">
